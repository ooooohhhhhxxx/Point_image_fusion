...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/Users/jinxuanchen/Files_Local/Point_image_fusion/kittidata/odometry/sequences/00/image_2/', help='file/dir/URL/glob/screen/0(webcam)')
